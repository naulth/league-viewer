...
function NavBar({ handleLogout }) {
    ...
    return (
        <header className="bg-zinc-950 border border-lime-200 sticky top-0">
            <nav
                className="mx-auto flex mx-w-7xl items-center justify-between h-24 gap-x-6 p-6 lg:px-8"
                aria-label="Global"
            >
                <div className="flex lg:flex-1 mt-auto">
                    <Link
                        className="text-3xl font-bold leading-6 tracking-tight text-lime-300"
                        to="/"
                    >
                        League Viewer
                    </Link>
                ...
                <div className="flex flex-1 items-center justify-end gap-x-6">
                    {user ? (
                        <p className="hidden lg:block lg:text-lg lg:font-semibold lg:leading-6 lg:text-lime-200">
                    ...
                    {user ? (
                        <div className="flex justify-between gap-x-6">
                            <Link
                                className="hidden lg:block lg:text-md lg:font-semibold lg:leading-6 lg:text-white"
                                to="/"
                    ...
                    {user ? null : (
                        <Link
                            to="/signup"
                            className="rounded-md bg-lime-300 px-3 py-2 text-md font-semibold text-zinc-950 shadow-sm hover:bg-lime-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-200"
                        >
                            Sign up
                        </Link>
                    )}
